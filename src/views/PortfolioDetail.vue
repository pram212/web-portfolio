  ...
  <ContentCard title="Portfolio Detail">
    <div>
        ...
        <Carousel :autoplay="3000" :items-to-show="1" :wrap-around="true"
          ...
          <Slide v-for="(item, index) in project.images" :key="index">
            <div class="carousel__item">
              <img :src="item.src" alt="image portfolio" class="h-96" />
            </div>
          </Slide>
        </Carousel>
      </figure>
      ...
      <div role="tablist" class="tabs tabs-bordered">
        <input type="radio" role="tab" name="my_tabs_3" class="tab text-error font-semibold" aria-label="Overview"
          checked="checked" />
        ...
        <input type="radio" role="tab" name="my_tabs_3" class="tab text-error font-semibold text-nowrap"
