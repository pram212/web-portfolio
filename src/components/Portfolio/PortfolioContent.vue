...
const getDetail = (index) => {
  detail.value = portfolios.value[index];
};
...
<template>
  ...
  <dialog id="modal_detail" class="modal modal-bottom bg-opacity-30">
    <div
    ...
    >
      <form method="dialog">
        <label
          for="modal_detail"
          class="btn btn-sm btn-circle btn-ghost absolute right-7"
          >✕</label
        >
      </form>
